...
export ENTU_QUERY="_type.string.regex=interview|story&props=_mid,_type,author,category,description_en,description_et,description_ru,featured,story,interview,language,path,photo,thumb,project,storyteller,subtitle_en,subtitle_et,subtitle_ru,title_en,title_et,title_ru,videoUrl&limit=9999"
