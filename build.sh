...
export ENTU_QUERY="_type.string.regex=interview|story&props=photo,path,videoUrl,title_et,title_en,title_ru,subtitle_et,subtitle_en,subtitle_ru,region&limit=10000"
